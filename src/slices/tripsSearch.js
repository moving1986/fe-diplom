...
const tripsSearchSlice = createSlice({
  name: "tripsSearchForm",
  initialState,
  reducers: {
    changeTripsSearchInput: (state, action) => {
      const { name, value } = action.payload;

      state[name] = value;
    },
    clearTripsSearch: (state) => {
...
export const selectTripsSearch = state => state.tripsSearch;
export const { changeTripsSearchInput, clearTripsSearch } = tripsSearchSlice.actions;
